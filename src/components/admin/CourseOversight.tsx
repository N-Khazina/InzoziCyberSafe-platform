...
import { BookOpen, Users, Clock, Star, Plus, Search, Filter, Eye, Edit, Trash2 } from 'lucide-react';
...
const CourseOversight = () => {
  ...
  const mockCourses: Course[] = [
    ...
    {
      id: '5',
      title: 'Old Security Practices',
      instructor: 'Former Instructor',
      category: 'Legacy',
      students: 45,
      duration: '4 weeks',
      rating: 3.2,
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <h3 className="text-lg font-medium text-gray-900 mb-4 sm:mb-0">Course Management</h3>
